            ...
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-success btn-xs" href="{{route('superadmin.permissions.show',$permission->id)}}">
                      <i class="fas fa-check-square"></i>
                    </a>
                    <a class="btn btn-warning btn-xs" href="{{route('superadmin.permissions.edit',$permission->id)}}">
                      <i class="far fa-edit"></i>
                    </a>
                    {!! Form::open(['method' => 'DELETE','route' => ['superadmin.permissions.destroy', $permission->id],'style'=>'display:inline']) !!}
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="{{ route('superadmin.permissions.store') }}" enctype="multipart/form-data">
            @csrf
